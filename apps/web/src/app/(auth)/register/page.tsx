      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
          ...
          <p style={{ color: "#9ca3af", fontSize: "0.875rem", margin: 0 }}>
            Start building custom Scraper REST APIs in minutes
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
          ...
          <button
            ...
            onMouseEnter={(e) => {
              if (!loading) e.currentTarget.style.backgroundColor = "#9333ea";
            }}
            onMouseLeave={(e) => {
        ...
        <p style={{
          ...
          <a href="/login" style={{ color: "#c084fc", textDecoration: "none", fontWeight: "500" }}>
            Sign In here
          </a>
        </p>
      </div>
